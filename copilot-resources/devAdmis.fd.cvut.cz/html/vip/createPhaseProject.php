...
if(isset($_GET['idProject'])){
    ...
    $form = generateCurrentPhaseForm($project, true);
}

$title = "Vytvořit etapu projektu"
    ...
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="card-header card-header-danger card-header-text">
                <div class="card-text">
                    <h4 class="card-title">Vytvoř etapu</h4>
                </div>
            </div>
            <div class="card-body">
                <form method='post' id='projectFormPhasing' action='../submits/createPhaseProjectSubmit.php'>
                    <?php echo $form ?>
                    <input type="hidden" name="edit" value="0">
                    <input type="hidden" name="isPhasing" value="1">
                    <input type="hidden" name="mergePricePDAD" value="0">
                    <input type="hidden" name="technologicalProjectType" value="normal">
...
$customScripts .= "<script src=/js/createPhase.js></script>";
