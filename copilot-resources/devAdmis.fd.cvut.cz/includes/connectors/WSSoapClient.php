...
class WSSoapClient extends SoapClient
{
   ...
   public function __soapCall($function_name, $arguments)
    ...
    private function generateWSSecurityHeader()
    {
        ...
        $xml = '
<Security xmlns="' . $this->OASIS . '/oasis-200401-wss-wssecurity-secext-1.0.xsd">
	<UsernameToken>
	<Username>' . $this->username . '</Username>
	<Password Type="' . $this->OASIS . '/oasis-200401-wss-username-token-profile-1.0#' . $this->passwordType . '">' . $password . '</Password>
';
